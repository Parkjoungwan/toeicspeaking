...
const Drill = {
  MODES: {
    A: { id: 'A', ko: '슬롯 채우기', sec: 12, desc: '템플릿 하나에 상황 하나. 빈칸에 뭐가 들어가는지 익힌다.' },
    B: { id: 'B', ko: '상황 연속 변환', sec: 7, desc: '같은 골격에 다른 상황 5연속. 골격을 손에 붙이는 핵심 드릴.' },
    C: { id: 'C', ko: '블록 조립', sec: 20, desc: '블록을 이어 완성 답안을 만든다.' },
    D: { id: 'D', ko: '말하기 전환', sec: 8, desc: '같은 상황을 보고 실제로 말하고 녹음한다.' }
  },
